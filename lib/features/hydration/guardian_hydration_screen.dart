...
class GuardianHydrationScreen extends ConsumerWidget {
  const GuardianHydrationScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final dataAsync = ref.watch(guardianHydrationMonitoringDataProvider);
    return AppScaffoldShell(
      title: 'Hydration monitoring',
      role: AppShellRole.guardian,
      currentRoute: AppRoutes.guardianHydration,
              ...
              Card(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Today: ${data.todayState.completedCount}/${data.todayState.dailyGoalCompletions} completed',
                      ),
                      Gaps.v4,
                      Text(
              ...
              if (data.recentEvents.isEmpty)
                const Card(
                  child: Padding(
                    ...
                    child: Text('No hydration events yet.'),
                  ),
                )
              else
